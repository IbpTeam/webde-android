...
public class JMDNSPlugin extends CordovaPlugin {
    NetworkDiscovery mNsdHelper;
    ...
    private void initNsd(CallbackContext callbackContext) {
        ...
        try {
            if (null == mHandler) {
                ...
                if (null == mNsdHelper) {
                    mNsdHelper = new NetworkDiscovery(cordova.getActivity(), mHandler);
...
//            mNsdHelper.setRegisterServiceCB(callbackContext);
            mNsdHelper.registerService(name, port, new String[]{"demo-rio", "cos", "rioxifeirio"});
            callbackContext.success("In registerService");
        }
        else {
...
//            mNsdHelper.setRegisterServiceCB(callbackContext);
            ...
            callbackContext.success("In unRegisterService");
        } else {
...
//        mNsdHelper.setResolveServiceCB(callbackContext);
        ...
        //callbackContext.success("In resolveService");
    }
